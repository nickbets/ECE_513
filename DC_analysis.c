    ...
    if (sparse_flag == 0) {
        ...
        if(iterative_flag == 1) {
            ...
            if(cholesky_flag ==1) {
                ...
                printf("CG solution runtime: %f seconds\n", cpu_time_used);
            }
            else{
                start = clock();
                ...
                printf("Bi-CG solution runtime: %f seconds\n", cpu_time_used);
            }
        }
        else {
            ...
            if (cholesky_flag == 1) {
                if (custom_flag == 1) {
                    ...
                    cpu_time_used = ((double)(end - start)) / CLOCKS_PER_SEC;
                    printf("Custom Cholesky decomposition runtime: %f seconds\n", cpu_time_used);
                    ...
                    printf("Custom Cholesky solution runtime: %f seconds\n", cpu_time_used);
                }
                else {
                    start = clock();
                    ...
                    cpu_time_used = ((double)(end - start)) / CLOCKS_PER_SEC;
                    printf("GSL Cholesky decomposition runtime: %f seconds\n", cpu_time_used);
                    ...
                    printf("GSL Cholesky solution runtime: %f seconds\n", cpu_time_used);
                }
            }
            else {
                int signum;
                ...
                if(custom_flag == 1) {
                    ...
                    cpu_time_used = ((double)(end - start)) / CLOCKS_PER_SEC;
                    printf("Custom LU decomposition runtime: %f seconds\n", cpu_time_used);
                    ...
                    printf("Custom LU solution runtime: %f seconds\n", cpu_time_used);
                }
                else {
                    start = clock();
                    ...
                    cpu_time_used = ((double)(end - start)) / CLOCKS_PER_SEC;
                    printf("GSL LU decomposition runtime: %f seconds\n", cpu_time_used);
                    ...
                    printf("GSL LU solution runtime: %f seconds\n", cpu_time_used);
                }
